...
class ReactDetector {
    async detect(files, workspaceRoot) {
        ...
        if (!rootFiles.includes('package.json')) {
            return { detected: false, technology: 'React', category: constants_1.CATEGORIES.REACT, confidence: 'low' };
        }
        try {
            ...
            return {
                detected,
                technology: 'React',
                category: constants_1.CATEGORIES.REACT,
...
//# sourceMappingURL=reactDetector.js.map